...
module.exports = {
    VERSION: 'v1.0.8',
    SESSION: process.env.Julie-V3_SESSION === undefined ? '' : process.env.ASENA_SESSION,
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME === undefined ? '🥰,Ajmal342' : process.env.STICKER_PACKNAME,
